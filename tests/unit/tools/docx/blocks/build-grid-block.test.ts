...
describe("buildGridBlock", () => {
  ...
  describe("default width distribution", () => {
    it("should create 2-column grid with 50/50 ratio", async () => {
      const result = await buildGridBlock.callback({}, { column_size: 2 });
    ...
    it("should create 3-column grid with 33/33/34 ratio", async () => {
      const result = await buildGridBlock.callback({}, { column_size: 3 });
    ...
    it("should create 4-column grid with equal distribution", async () => {
      const result = await buildGridBlock.callback({}, { column_size: 4 });
    ...
    it("should create 5-column grid with equal distribution", async () => {
      const result = await buildGridBlock.callback({}, { column_size: 5 });
  ...
  describe("output format", () => {
    ...
    it("should return structuredContent", async () => {
      ...
      expect(result.structuredContent?.grid.block_type).toBe(24);
      expect(result.structuredContent?.columns).toHaveLength(2);
    });
  });
});
